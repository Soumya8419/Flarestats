<template>
  ...
  <div>
    <MDBTabs v-model="activeTabId1">
      ...
      <MDBTabNav
        pills
        tabsClasses=" nav justify-content-center nav-fill ms-2 me-1"
      >
        <MDBTabItem
          tabId="ex1-1"
          class="bg-primary text-white align-items-stretch"
          href="ex1-1"
        >
          <img
        ...
        <MDBTabItem
          tabId="ex1-2"
          class="bg-danger text-white align-items-stretch"
          href="ex1-2"
        >
          <img
        ...
        <MDBTabItem
          tabId="ex1-3"
          class="bg-success text-white align-items-stretch"
          href="ex1-3"
        >
          <img
      ...
      <MDBTabContent>
        ...
        <MDBTabPane tabId="ex1-2">
          ...
          <div class="table-responsive">
            <MDBTable class="table">
              <thead class="bg-danger text-dark bg-opacity-25">
                <tr>
                  <th>Rank</th>
                  <th>Name</th>
                  <th>Reward Rate</th>
        ...
        <MDBTabPane tabId="ex1-3">
          <div class="container align-left mb-5 bg-white fs-6">
            ...
            <div class="note note-success mb-3">
              ...
              <p>
                As we strive to better at scoring to be Top-20 FTSO, we will
                continue building more apps to bring our FTSO community
                together.
              </p>
              <p>You can reach us on Twitter @ Flareportal</p>
              <p>
                We also have a Forum on our website at Flareportal where our
                community can post questions and answers.
              </p>
              <p>
                Reach out to the community at https://flareportal.com/forum/
              </p>
            </div>
            ...
            <p>
              <span data-contrast="auto">
                <div class="note note-success mb-3">
                  This app provides <b>FTSO'</b>s listed and sorted decending on
                  their <b>‘Reward Rate’</b>.
                  <p></p>
                  SGB / FLR holders can delegate their tokens to their own
                  choice of Data Providers (TSO&rsquo;s also named
                  FTSO&rsquo;s). By delegating your vote, your assets will stay
                  in your possession.
                  <p></p>
                  The Flare Portal xApp provides key information to select on
                  this delegation process. Data is updated as per (in the xApp)
                  indicated interval / last updated information.
                </div></span
              >
            </p>
            <p>
            ...
            <p class="fs-6">
              <span data-contrast="auto">
                <div class="note note-success mb-3">
                  ...
                  <p></p>
                  The Vote Power of a FTSO / Data Provider is the sum of its
                  balance Vote Power and all balance vote powers delegated to it
                  by other accounts. The calculation is based on the Current
                  Vote Power of the Data Provider (not the Active Vote Power).
                  <p></p>
                  The Active Vote Power of an account is its Vote Power at a
                  specific block, called the Vote Power Block, whereas the
                  Current Vote Power is the Vote Power is the sum of its balance
                  Vote Power and all balance Vote Powers delegated to it by
                  other accounts prior to the Vote Power Block. The Current Vote
                  Power is therefore a more usefull indicator for the upcoming
                  Reward Epoch, as if the Data Provider exceeds the Vote Power
                  Cap it impacts the reward ratio. The Vote Power Cap lowers the
                  maximum power a data provider can have in deciding the median
                  price of a signal.
                </div>
              </span>
            </p>
            ...
            <p>
              <span data-contrast="auto"
                ><b>When do I start earning rewards?</b></span
              ><span data-ccp-props="{}">&nbsp;</span>
            </p>
            <p>
              <span data-contrast="auto"
                ><div class="note note-warning mb-3">
                  A vote power block (snapshot) is created (automatically and
                  random time/date - around the beginning of the new epoch).
                  Example for Songbird: Your vote power should be delegated to a
                  FTSO for the upcoming epoch before the above-mentioned
                  snapshot and accruing rewards starts in regrards to Songbird
                  Network after 08:41 UTC on Saturday in regards to Songbird.
                  The Reward Epoch cycle for Flare network is 3.5 days (twice a
                  week). .
                </div></span
              >
            </p>
            ...
            <p class="fs-6">
              <span data-contrast="auto">
                <div class="note note-primary mb-3">
                  Support us by delegating your wrapped SGB / FLR to Flare
                  Portal.
                  <p></p>
                  Delegation can be done via e.g. Bifrost Wallet.
                  <p></p>
                  In Bifrost Wallet you can wrap your SGB / FLR and delegate to
            ...
            <p>
              <span data-contrast="auto"
                ><b>xAPP and WEBSITE DISCLAIMER</b></span
              >
            </p>
            <p>
              <span data-contrast="auto"
                ><div class="note note-warning mb-3">
                  ...
                  &ldquo;Site&rdquo;) is for general informational purposes
                  only. Use of the information is at your own risk as our
                  technical process could fail updating the information. The
                  information provided does not contain financial advice. Don't
                  rely on the information to make financial decisions. All
                  ...
                  on the Site. UNDER NO CIRCUMSTANCE SHALL WE HAVE ANY LIABILITY
            ...
            <p>
              <span data-contrast="auto"
                ><div class="note note-warning mb-3">
                  ...
                  features in banners or other advertising. Such external links
